...
public class BukuDaoImpl implements BukuDao {
    ...
    public void Update(Buku buku) throws Exception {
        String update = "UPDATE Buku SET judulBuku = ?, pengarang = ?, penerbit = ?, tahunTerbit = ? WHERE kodeBuku = ?";
    ...
    public void Delete(Buku buku) throws Exception {
        String delete = "DELETE FROM Buku WHERE kodeBuku = ?";
    ...
    public Buku getBuku(String kode) throws Exception {
        String all = "SELECT * FROM Buku WHERE kodeBuku = ?";
